...
- [ ] 모호성 follow-up 분석
- [ ] 최종 Plan 승인 수령
- [ ] `components.md` 생성 — 컴포넌트 정의/책임/인터페이스
- [ ] `component-methods.md` 생성 — 메서드 시그니처 (business rules는 per-unit)
- [ ] `services.md` 생성 — 서비스 orchestration 패턴
- [ ] `component-dependency.md` 생성 — 의존 관계 + 통신 패턴 + 데이터 흐름
- [ ] `application-design.md` 생성 — 위 내용 통합 문서
